...
const CL_SECTIONS = [
  ...
  {"id":8,"title":"유형 8","items":["나는 의사 결정을 할 때 적절히 지도력을 발휘한다.","나는 늘 강해야 된다고 생각한다.","나는 사람들에게 영향력 있는 사람이다.","나는 다른 사람들이 말하기 어려워하는 것을 이야기 한다.","나는 공격적이고 자기주장이 강하다.","나는 사람들을 통제하려 한다.","나는 사람들을 지시하고 동기를 부여한다.","나는 강한 자신감으로 사람들을 설득시킨다."]},
